...
# The finally clause serves as the last clause before the try statement completes. 
...
# the try statement will stop executing, and the program will move to the except block to handle the exception. 
